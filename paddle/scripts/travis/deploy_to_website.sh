...
cp -r $TRAVIS_BUILD_DIR/build/doc/en $TRAVIS_BUILD_DIR/build_docs_versioned/$TRAVIS_BRANCH/en
cp -r $TRAVIS_BUILD_DIR/build/doc/cn $TRAVIS_BUILD_DIR/build_docs_versioned/$TRAVIS_BRANCH/cn
...
rsync -r ./stripped_doc/ ubuntu@52.76.173.135:/var/content/docs
